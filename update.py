...
def monitor_log():
    ...
    with open(LOG_FILE, "r", encoding="utf-8", errors="ignore") as f:
        ...
        while True:
            ...
            # "Do you want to use the existing", 
            # 또는 "you want to use the existing" 문자열을 감지하면 'y' 입력
            if ("Do you want to use the existing user account? (y/n)" in line
                or "Do you want to use the existing" in line
                or "you want to use the existing" in line
                or "existing user account" in line):
